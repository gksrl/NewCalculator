...
namespace NewCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void btn_one_Click(object sender, EventArgs e)       // 1 버튼 클릭
        {
            processbox.Text += ("1");
        }

        private void btn_two_Click(object sender, EventArgs e)       // 2 버튼 클릭
        {
            processbox.Text += ("2");
        }

        private void btn_3_Click(object sender, EventArgs e)       // 3 버튼 클릭
        {
            processbox.Text += ("3");
        }

        private void btn_4_Click(object sender, EventArgs e)       // 4 버튼 클릭
        {
            processbox.Text += ("4");
        }

        private void btn_5_Click(object sender, EventArgs e)       // 5 버튼 클릭
        {
            processbox.Text += ("5");
        }

        private void btn_6_Click(object sender, EventArgs e)       // 6 버튼 클릭
        {
            processbox.Text += ("6");

        }

        private void btn_7_Click(object sender, EventArgs e)       // 7 버튼 클릭
        {
            processbox.Text += ("7");
        }

        private void btn_8_Click(object sender, EventArgs e)       // 8 버튼 클릭
        {
            processbox.Text += ("8");
        }

        private void btn_9_Click(object sender, EventArgs e)       // 9 버튼 클릭
        {
            processbox.Text += ("9");
        }

        private void btn_0_Click(object sender, EventArgs e)       // 0 버튼 클릭
        {
            processbox.Text += ("0");
        }
        ...
        private void btn_plus_Click(object sender, EventArgs e) // 더하기 연산 
        {
            ...
            op = '+';                                                   // operand 에 '+' 대입
            temp += Convert.ToDouble(processbox.Text);                  // temp에 processbox의 값을 더하기 할당 연산
        ...
        private void btn_point_Click(object sender, EventArgs e)       // . 버튼 클릭
        {
            processbox.Text += (".");
        }
    }
