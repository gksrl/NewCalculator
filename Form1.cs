...
namespace NewCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void btn_minus_Click(object sender, EventArgs e) // 빼기 연산 
        {
            ...
            {
                temp -= (Convert.ToDouble(resultbox.Text)) * -1;       // temp = temp - (processbox) x -1 (초기값을 양수로 만듬)
                processbox.Text = Convert.ToString(temp);                // resultbox에 temp 값 출력

                resultbox.Text = "";                                   // processbox 공백으로 초기화 
                count++;                                                // count 연산 증가 
            }

            else                                                        // 빼기 연산이 처음이 아닌 경우
            {
                temp -= Convert.ToDouble(resultbox.Text);              // temp = temp - processbox   1 = 1 - 2
                processbox.Text = Convert.ToString(temp);                // resultbox에 temp 값 출력
        ...
        private void btn_multiple_Click(object sender, EventArgs e)  // 곱샘 연산 
        {
            ...
            temp *= Convert.ToDouble(resultbox.Text);                  // temp = temp * processbox 
            processbox.Text = Convert.ToString(temp);                    // resultbox에 temp 값 출력
        ...
        private void btn_divide_Click(object sender, EventArgs e) // 나누기 연산 
        {
            ...
            if (count == 0)                                             // 나누기 연산이 처음인 경우
            {
                ...
                temp = Convert.ToDouble(resultbox.Text) / 1;           // temp = processbox / 1 
                processbox.Text = Convert.ToString(temp);                // resultbox에 temp 값 출력
        ...
        private void btn_result_Click(object sender, EventArgs e) // = 연산 
        {
            ...
            if (op == '+') // operand 가 + 일 때 
            {
                ...
                processbox.Text = Convert.ToString(temp);                // resultbox에 temp 값 출력
                processbox.Text += " ";
                processbox.Text += "+";                                  // resultbox에 "+" 출력
                processbox.Text += resultbox.Text;                      // resultbox에  processbox 값 출력
                processbox.Text += " ";
                processbox.Text += "=";                                  // resultbox에 "=" 출력
                temp += Convert.ToDouble(resultbox.Text);              // temp = temp + processbox
            ...
            else if (op == '*') // operand 가 * 일 때
            {
                ...
                processbox.Text = Convert.ToString(temp);                // resultbox에 temp 값 출력
                processbox.Text += " ";
                processbox.Text += "x";                                  // resultbox에 "x" 출력
                processbox.Text += resultbox.Text;                      // resultbox에  processbox 값 출력
                processbox.Text += " ";
                processbox.Text += "=";                                  // resultbox에 "=" 출력
                temp *= Convert.ToDouble(resultbox.Text);              // temp = temp * processbox
